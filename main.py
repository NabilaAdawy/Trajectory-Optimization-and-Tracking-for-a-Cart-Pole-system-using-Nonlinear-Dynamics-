...
A_num, B_num = num_jacobian(x_sym, u_sym, sym_param, x_d, u_opt, num_param, N, C, D, dT, 'var')
...
X, U = simulation(N, N2, dT, Q, R, C, D, x_0, xd, ud, Kd, x_d, u_opt, K_vt, x_sym, u_sym, sym_param, num_param)
